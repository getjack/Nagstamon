...
class Ui_settings_action(object):
    def setupUi(self, settings_action):
        ...
        settings_action.resize(752, 1017)
        ...
        self.gridLayout.addWidget(self.input_lineedit_re_attempt_pattern, 28, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.input_radiobutton_close_popwin, 37, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.input_radiobutton_leave_popwin_open, 38, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.input_checkbox_re_duration_enabled, 29, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.button_box, 40, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.label_status_popup, 34, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_checkbox_re_duration_reverse, 30, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_lineedit_re_duration_pattern, 30, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.input_checkbox_recheck, 39, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.input_checkbox_re_attempt_enabled, 27, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.input_checkbox_re_attempt_reverse, 28, 5, 1, 1)
        ...
        settings_action.setTabOrder(self.input_checkbox_re_duration_reverse, self.input_checkbox_re_groups_enabled)
        settings_action.setTabOrder(self.input_checkbox_re_groups_enabled, self.input_radiobutton_close_popwin)
